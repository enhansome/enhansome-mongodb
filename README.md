...
[![Links check](https://github.com/ramnes/awesome-mongodb/actions/workflows/links.yml/badge.svg)](https://github.com/ramnes/awesome-mongodb/actions/workflows/links.yml) ⭐ 2,676 | 🐛 11 | 📅 2026-08-26

> A curated list of awesome MongoDB resources, libraries, tools and applications

Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,019 | 🐛 106 | 📅 2026-09-02 list thing. Feel free to improve this list by [contributing](CONTRIBUTING.md)!
...
* [MongoDB source code](https://github.com/mongodb/mongo) ⭐ 28,566 | 🐛 34 | 🌐 C++ | 📅 2026-09-14
...
* [mongo-c-driver](https://github.com/mongodb/mongo-c-driver) ⭐ 882 | 🐛 7 | 🌐 C | 📅 2026-09-17 - Official C driver

### C++

* [mongo-cxx-driver](https://github.com/mongodb/mongo-cxx-driver) ⭐ 1,107 | 🐛 2 | 🌐 C++ | 📅 2026-09-16 - Official C++ driver
...
* [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) ⭐ 8,538 | 🐛 26 | 🌐 Go | 📅 2026-09-17 - Official Go driver
...
* [mongo-java-driver](https://github.com/mongodb/mongo-java-driver) ⭐ 2,663 | 🐛 41 | 🌐 Java | 📅 2026-09-17 - Official Java driver
* [Spring Data MongoDB](https://github.com/spring-projects/spring-data-mongodb) ⭐ 1,687 | 🐛 318 | 🌐 Java | 📅 2026-09-17 - Spring based, object-document support and repositories
...
* [Morphium](https://github.com/sboesebeck/morphium) ⭐ 63 | 🐛 46 | 🌐 Java | 📅 2026-09-17 - Java ODM and caching layer

### JavaScript

* [Meteor](https://github.com/meteor/meteor) ⭐ 44,805 | 🐛 332 | 🌐 JavaScript | 📅 2026-09-17 - Real-time/reactive client-server framework based on MongoDB, with lots of features
* [Mongoose](https://github.com/Automattic/mongoose) ⭐ 27,472 | 🐛 170 | 🌐 JavaScript | 📅 2026-09-15 - Node.js asynchronous ODM
* [node-mongodb-native](https://github.com/mongodb/node-mongodb-native) ⭐ 10,178 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-16 - Official Node.js driver
* [CASL Mongoose](https://github.com/stalniy/casl/tree/master/packages/casl-mongoose) ⭐ 7,081 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-17 - Permissions management library integrated with Mongoose
...
* [driver-kotlin-coroutine](https://github.com/mongodb/mongo-java-driver/tree/master/driver-kotlin-coroutine) ⭐ 2,663 | 🐛 41 | 🌐 Java | 📅 2026-09-17 - Official Kotlin driver
...
* [Doctrine MongoDB ODM](https://github.com/doctrine/mongodb-odm) ⭐ 1,096 | 🐛 104 | 🌐 PHP | 📅 2026-09-17 and [MongoDB ODM Bundle for Symfony](https://github.com/doctrine/DoctrineMongoDBBundle) ⭐ 384 | 🐛 15 | 🌐 PHP | 📅 2026-06-30 - Fully featured ORM with Symfony integration
...
* [PyMongo](https://github.com/mongodb/mongo-python-driver) ⭐ 4,355 | 🐛 14 | 🌐 Python | 📅 2026-09-17 - Official Python driver
...
* [Motor](https://github.com/mongodb/motor) ⭐ 2,525 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - Official non-blocking Python driver for Tornado or asyncio
...
* [mongodb-rust-driver](https://github.com/mongodb/mongo-rust-driver) ⭐ 1,517 | 🐛 7 | 🌐 Rust | 📅 2026-09-16 - Official Rust driver

### Scala

* [driver-scala](https://github.com/mongodb/mongo-java-driver/tree/master/driver-scala) ⭐ 2,663 | 🐛 41 | 🌐 Java | 📅 2026-09-17 - Official Scala driver
...
* [Compass](https://github.com/mongodb-js/compass) ⭐ 1,494 | 🐛 42 | 🌐 TypeScript | 📅 2026-09-17 - Free Cross-platform GUI from MongoDB
...
* [MongoDB MCP Server](https://github.com/mongodb-js/mongodb-mcp-server) ⭐ 1,131 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-17 - Official Model Context Protocol server for interacting with MongoDB databases and MongoDB Atlas
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 1,107 | 🐛 237 | 🌐 Go | 📅 2026-09-17 - Free and open-source platform for managing and monitoring databases performances
...
* [Appwrite](https://github.com/appwrite/appwrite) ⭐ 57,393 | 🐛 989 | 🌐 PHP | 📅 2026-09-17 - Open-source Firebase alternative
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 41,075 | 🐛 1,222 | 🌐 JavaScript | 📅 2026-09-17 - Open-source Retool alternative
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 40,892 | 🐛 4,473 | 🌐 TypeScript | 📅 2026-09-17 - Open-source Retool alternative
* [Budibase](https://github.com/Budibase/budibase) ⭐ 28,290 | 🐛 270 | 🌐 TypeScript | 📅 2026-09-17 - Open-source Retool alternative
...
* [mongosh](https://github.com/mongodb-js/mongosh) ⭐ 403 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-17 - Official command-line client
* [MongoDB Atlas CLI](https://github.com/mongodb/mongodb-atlas-cli) ⭐ 184 | 🐛 6 | 🌐 Go | 📅 2026-09-17 - Official Atlas API command-line client
...
* [NodeBB](https://github.com/NodeBB/NodeBB) ⭐ 15,219 | 🐛 136 | 🌐 JavaScript | 📅 2026-09-17 - Node.js based forum software ("built for the modern web")
...
* [CodeCombat](https://github.com/codecombat/codecombat) ⭐ 8,570 | 🐛 420 | 🌐 JavaScript | 📅 2026-09-17 - Multiplayer programming game for learning how to code
* [Countly](https://github.com/countly/countly-server) ⭐ 5,904 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-17 - Mobile & web analytics and marketing platform built with Node.js
...
* [Errbit](https://github.com/errbit/errbit) ⭐ 4,269 | 🐛 148 | 🌐 Ruby | 📅 2026-09-17 - A Ruby on Rails based tool for collecting and managing errors from other applications.
* [uptime](https://github.com/fzaninotto/uptime) ⚠️ Archived - Remote monitoring application built with Node.js and Bootstrap
* [WildDuck Mail Server](https://github.com/nodemailer/wildduck) ⭐ 2,108 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-17 - Scalable high availability email server that uses MongoDB for email storage
